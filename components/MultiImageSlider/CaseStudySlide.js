...
const CaseStudySlide = ({ slide, Speed }) => {
            ...
            <div className="clients__list">
              <div ref={sliderRef} className="keen-slider">
                {slide?.images?.length > 0 &&
                  [...slide?.images, ...slide?.images].map((item, index) => (
                    <div
                      key={`brand-${index}`}
                      className="clients__image keen-slider__slide"
                    >
                      <div className="clients__img">
                        <Image
                          ...
                          height={332}
                          src={
                            item?.Image?.filename || item?.ImageLink?.filename
                          }
