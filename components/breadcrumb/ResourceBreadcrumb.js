                        ...
                        <div className='inner'>
                            {!showBreadcrumb && (
                                <ul className='axil-breadcrumb liststyle d-flex'>
                                    <li className='axil-breadcrumb-item' style={{ color: '#000000', cursor: 'default' }}>
                                        {root}
                                    </li>
                            ...
                            <div className={`row`}>
                                ...
                                {description && <div className='desc text-capitalize'>{description}</div>}
                                {showSearch && (
                                    <div
                                        className={`${router?.asPath === '/blog' || router?.asPath === '/blog/page/1'
                                            ? 'blogSearch__wrapper'
                                            : ''
                                            }`}
                                    >
